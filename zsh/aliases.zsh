...
alias rep='rake parallel:spec'
alias re='rspec'
alias rf='rspec --only-failures'
alias guard='bundle exec guard'
alias rub='bin/rubocop -P'
alias ruba='bin/rubocop -A'
alias rubF='rm -rf ~/.cache/rubocop_cache && mkdir ~/.cache/rubocop_cache && sudo chown -R $(whoami) ~/.cache/rubocop_cache'
alias ord='ordinare'

# parallel_tests
alias pdbc='rake parallel:create'
alias pdbm='rake parallel:migrate'
alias pre='bin/parallel_rspec'
